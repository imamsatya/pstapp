          ...
          <q-card>
            ...
            <q-tab-panels v-model="tab" animated>
              ...
              <q-tab-panel name="login">
                ...
                <q-input standout v-model="email_login" type="email" prefix="bps" suffix="@bps.go.id"
                  placeholder="kode satker" hint="Tulis kode satkernya aja, cth : 7206">
                  <template v-slot:prepend>
                    <q-icon name="mail" />
                  </template>
                </q-input> <br>

                <q-input standout v-model="password_login" :type="isPwd ? 'password' : 'text'"
                  hint="Hayo passwordnya apa" placeholder="Password">
              ...
              <q-tab-panel name="register">
                ...
                <q-input standout v-model="email_register" type="email" prefix="bps" suffix="@bps.go.id"
                  placeholder="kode satker" hint="Tulis kode satkernya aja, cth : 7206">
                  <template v-slot:prepend>
                    <q-icon name="mail" />
                  </template>
                ...
                <q-input standout v-model="password_register_t" :type="isPwd ? 'password' : 'text'"
                  hint="Hayo passwordnya apa" placeholder="Password">
                  <template v-slot:append>
                    <q-icon :name="isPwd ? 'visibility_off' : 'visibility'" class="cursor-pointer"
                      @click="isPwd = !isPwd" />
                ...
                <q-input standout v-model="password_register" :type="isPwdx ? 'password' : 'text'" hint="Sekali lagi"
